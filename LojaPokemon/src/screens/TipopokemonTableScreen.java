 ...
 * @author Matheus
 */
public class TipopokemonTableScreen extends JDialog {
    ...
    //DADOS
    List<Tipopokemon> tipopokemons;

    public TipopokemonTableScreen(List<Tipopokemon> tipopokemons) {
        this.tipopokemons = tipopokemons;

        setDefaultCloseOperation(DISPOSE_ON_CLOSE);
        setLocationRelativeTo(null);
        setTitle("CRUD - TIPOPOKEMON");
        ...
        for (int i = 0; i < this.tipopokemons.size(); i++) {
            aux = this.tipopokemons.get(i).toString().split(";");
